...
const eventsData = [
  ...
  {
    id: 5,
    title: "Atölye Sorumluları Genel Toplantısı",
    date: "2025-03-28",
    type: "meeting",
  ...
  {
    id: 6,
    title: "Bahar Dönemi Proje Şenliği",
    date: "2025-05-15",
    endDate: "2025-05-20",
    type: "event",
    description: "Tüm atölyelerde bahar dönemi proje şenlikleri düzenlenecektir.",
    audience: ["all-workshops"],
    commission: "Eğitim Programları Komisyonu",
  },
  {
    id: 7,
    title: "Yeni Eğitim İçerikleri Değerlendirmesi",
    date: "2025-04-15",
    type: "deadline",
    description: "2025-2026 Eğitim yılı için hazırlanan yeni eğitim içeriklerinin değerlendirilmesi son tarihi.",
    audience: ["workshop-managers"],
    commission: "Eğitim Programları Komisyonu",
  },
]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">DENEYAP Takvimi</h1>
          <p className="text-muted-foreground">Sistem geneli etkinlik ve tarih planlaması</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-12">
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-muted-foreground mt-1">
                            {event.endDate
                              ? `${new Date(event.date).toLocaleDateString("tr-TR")} - ${new Date(event.endDate).toLocaleDateString("tr-TR")}`
          ...
          <CardContent>
            {selectedEvent ? (
              <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-sm">
                      {selectedEvent.endDate
                        ? `${new Date(selectedEvent.date).toLocaleDateString("tr-TR")} - ${new Date(selectedEvent.endDate).toLocaleDateString("tr-TR")}`
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm">
                      ...
                      <p className="text-muted-foreground">
                        {selectedEvent.audience.includes("all-workshops") ? "Tüm Atölyeler" : ""}
                        {selectedEvent.audience.includes("workshop-managers") ? "Atölye Sorumluları" : ""}
                        {selectedEvent.audience.includes("commission-members") ? "Komisyon Üyeleri" : ""}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                {selectedEvent.type === "deadline" && (
                  <div className="pt-2">
                    <h4 className="font-medium mb-2">Görev Tamamlama Durumu</h4>
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span>Tamamlanan</span>
                        <span className="font-medium">
                          {selectedEvent.audience.includes("all-workshops") ? "18/28 Atölye" : "6/10 Görevli"}
                        </span>
                      </div>
                      <Progress value={selectedEvent.audience.includes("all-workshops") ? 64 : 60} className="h-2" />
                    </div>
                  </div>
                )}
              </div>
        ...
        <Card className="md:col-span-12">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="font-medium">Görünüm</h4>
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      id="show-weekends"
                    ...
                    />
                    <Label htmlFor="show-weekends">Hafta Sonlarını Göster</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="show-past-events" defaultChecked />
                    <Label htmlFor="show-past-events">Geçmiş Etkinlikleri Göster</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="show-completed" defaultChecked />
                    <Label htmlFor="show-completed">Tamamlanan Görevleri Göster</Label>
                  </div>
                </div>
              </div>
        ...
        <Card className="md:col-span-12">
          <CardHeader>
            ...
            <CardDescription>Takvim ile ilgili ek işlemler</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <p className="text-sm text-muted-foreground mb-4">
                  Takvimdeki tüm etkinliklerin detaylı raporunu indirin.
                </p>
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => {
                    toast({
                      ...
                      description: "Takvim raporu indiriliyor, lütfen bekleyin.",
                    })
                    ...
                    setTimeout(() => {
                      toast({
                        ...
                        description: "Takvim raporu başarıyla indirildi.",
                      })
                    }, 1500)
                  }}
                >
