...
import { ArrowLeft, Calendar, Edit, FileText, Mail, MapPin, MessageSquare, Phone, Users } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button asChild>
          <Link href={`/dashboard/superadmin/workshops/${workshop.id}/edit`}>
